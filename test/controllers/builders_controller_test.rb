...
class BuildersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create builder" do
    assert_difference("Builder.count") do
      post builders_url, params: { builder: { name: @builder.name, proyect_id: @builder.proyect_id } }
    end
  ...
  test "should update builder" do
    patch builder_url(@builder), params: { builder: { name: @builder.name, proyect_id: @builder.proyect_id } }
